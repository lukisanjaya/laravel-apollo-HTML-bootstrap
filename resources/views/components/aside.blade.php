        ...
        <div data-pixr-simplebar>
            <div class="pb-6">
                ...
                <div class="d-flex d-xl-none justify-content-between align-items-center border-bottom aside-header">
                    <a class="navbar-brand lh-1 border-0 m-0 d-flex align-items-center" href="./dashboard">
                ...
                <ul class="list-unstyled mb-6">
                    ...
                    <li class="menu-item"><a class="d-flex align-items-center" href="./charts">
                            <span class="menu-icon">
                    ...
                    <li class="menu-item"><a class="d-flex align-items-center collapsed" href="#"
                        ...
                        <div class="collapse" id="collapseMenuItemPages">
                            <ul class="submenu">
                                ...
                                <li><a href="./user-listing">User Listing</a></li>
                    ...
                    <li class="menu-item"><a class="d-flex align-items-center" href="#"
                        ...
                        <div class="collapse" id="collapseMenuItemUI">
                            <ul class="submenu">
                                ...
                                {{-- <li><a href="./tables" class="active">Tables</a></li> --}}
                            </ul>
                        </div>
                    </li>
                    <!-- / UI Kit Menu Section-->
