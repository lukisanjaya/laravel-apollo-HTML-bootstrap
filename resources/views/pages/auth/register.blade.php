...
@section('main')
    ...
    <div class="d-flex flex-column w-100 align-items-center">
        ...
        <div class="shadow-lg rounded p-4 p-sm-5 bg-white form mb-4">
            ...
            <a href="#" class="btn btn-facebook d-block mb-2"><i class="ri-facebook-circle-fill align-bottom"></i>
                Login
                with Facebook</a>
            <a href="#" class="btn btn-twitter d-block mb-2"><i class="ri-twitter-fill align-bottom"></i> Login
                with
                Twitter</a>
            ...
            <p class="d-block text-center text-muted small">Already registered? <a
                    class="text-muted text-decoration-underline" href="./login">Login here.</a></p>
        </div>
    </div>
    <!-- / Login Form-->
@endsection
