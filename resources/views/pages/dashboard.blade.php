...
@section('main')
    ...
    <p class="text-muted mb-5">Get a quick overview of your company's current status below, or click into one of the sections
            ...
            <div class="card h-100 bg-primary border-primary">
                <div class="card-header bg-transparent justify-content-between align-items-center d-flex border-0 pb-0">
                    <div class="d-flex align-items-center flex-shrink-0">
                        ...
                        <h6 class="card-title m-0 text-light fs-xs text-uppercase fw-bolder tracking-wide">Upcoming Events
                        </h6>
                    </div>
                                ...
                                <div class="swiper-slide text-white">
                                    ...
                                    <div class="d-flex mb-4 align-items-start">
                                        ...
                                        <div>
                                            ...
                                            <small class="d-block lh-1 opacity-75 mt-2">Review sales staff with Mike, John,
                                                Sally</small>
                                        </div>
                                    </div>
                                    <!-- / Event Date & Title-->
                ...
                <div class="card-body overflow-hidden">
                    <div class="row gx-2 h-100">
                        <div class="col-3 d-none d-xl-flex h-100 align-items-center">
                            <picture>
                                <img class="w-100" src="./assets/images/undraw_testimonials_4c7y.svg"
                        ...
                        <div
                            ...
                            <p class="text-muted">We'll give you a month's pro subscription for every friend that signs up
                                to Apollo.</p>
                        ...
                        <div class="col-3 d-none d-xl-flex h-100 align-items-center">
                            <picture>
                                <img class="w-100" src="./assets/images/undraw_mobile-apps_p0aa.svg"
                                    alt="HTML Bootstrap Admin Template by Pixel Rocket">
                            </picture>
                        </div>
                    </div>
        ...
        <div class="col-12 col-lg-6">
            <div class="card mb-4 h-100">
                ...
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-outline-secondary btn-sm text-body me-0 ms-auto d-table mt-3 pb-2"
